...
def setupThemesDataCentres(self, portal):
    ...
    for themeId in ['air', 'biodiversity', 'climate', 'landuse', 'water']:
        ...
        print 'dc folder in %s created' % themeId
...
def setupGeocoding(context):
    ...
    # This update was already ran, we don't need it anymore
    already_ran = True
    if not already_ran:
