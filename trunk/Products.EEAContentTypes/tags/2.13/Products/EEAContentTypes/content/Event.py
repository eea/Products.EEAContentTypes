...
QuickEvent_schema['themes'].widget.description = 'Please choose one theme to relate with this Event. If none apply please select default.'
QuickEvent_schema['themes'].widget.description_msgid ='EEAContentTypes_help_themes_event'
...
QuickEvent_schema['location'].widget = LocationWidget(description = "",
						      ...
						      i18n_domain = "plone")
QuickEvent_schema['location'].widget.description = 'Use the address to retrieve the location <em>(e.g. Kongens Nytorv 6, 1050 Copenhagen K, Denmark)</em>'
QuickEvent_schema['location'].widget.description_msgid ='EEAContentTypes_help_location_event'
